class uploadV {
    constructor() {
        ...
        this.selectBtnStyle = {width: "100px", height: "40px", background: "orangered", borderRadius:"5px",color: "#fff",position:"relative"};
        this.uploadBtnStyle = {width: "100px", height: "40px", background: "lightgreen", color: "#fff"};
    ...
    createContainer(container, parent, callback) {
        ...
        this.container.style.cssText = "width:auto;overflow:hidden;border:1px solid #ccc;margin:0 auto";
    ...
    createSelectBtn(btnEle) {//选择按钮
        ...
        //添加样式
        selectdiv.style.cssText = "width:" + this.selectBtnStyle.width + ";height:" + this.selectBtnStyle.height + ";background:" + this.selectBtnStyle.background+";position:relative;border-radius:5px;line-height:40px";
        ...
        span.style.cssText = "width:100%;height:" + this.selectBtnStyle.height + ";background:"
            ...
            ";position:absolute;left:0;right:0;top:0;bottom:0;margin:auto;line-height:38px;text-align:center;";
        span.innerHTML = "选择文件";
        ...
        //隐藏上传控件
        input.style.cssText = "width:" + 150 + "px;height:" + 40 + "px;background:blue;color:#000;opacity:0";
    ...
    createUploadBtn(btnEle) {
        ...
        var upbtn = this.uploadBtn = document.createElement("button");
        upbtn.style.cssText = "display: block;clear: both;float: right;margin-right: 0.5rem;";
        upbtn.innerHTML = "上传";
    ...
    createList(ele) {//存放list
        ...
        video.style.cssText = "width:100%;height:170px;";
        ...
        return {
            video: video, message: message, back: back, del: del
        }
    }
